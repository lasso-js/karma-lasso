...
// makes the coverage path relative. This is required because the `browserify-istanbul` transforms
...
var Reporter = function(config, helper, logger) {
    ...
    this.onBrowserComplete = function(browser, result) {
        ...
        if (!util.isArray(config.lasso.coverage.reporters)) {
            config.lasso.coverage.reporters = [
                config.lasso.coverage.reporters
            ];
        }
        config.lasso.coverage.reporters.forEach(function(reporterConfig) {
